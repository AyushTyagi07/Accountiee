...
document.getElementById("AddPayments").addEventListener("click", function(){
  var price = document.getElementById("Price").value;
   console.log("PID:"+ pid);
   console.log("started");
   var updatedbal = gbalance-price;
   console.log("PID:"+ pid)
   var pname = "Payment";
   var today = new Date();
   ...
   knex("Transaction").insert([{
     ...
     Balance:updatedbal
              ...
              alertify.notify('Payment Added', 'success',5);
               document.getElementById("TotalPending").innerHTML="";
              document.getElementById("username").value="";
              document.getElementById("Price").value="";
              document.getElementById("NewPending").innerHTML="";
            })
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          /*execute a function when someone clicks on the item value (DIV element):*/
              ...
              .then(function(rows) {
                ...
                console.log('Current Balance :' + gbalance);
                document.getElementById("TotalPending").innerHTML = gbalance;
              })
